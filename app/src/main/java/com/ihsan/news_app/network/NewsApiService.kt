...
private const val API_KEY="44367a5ac76040d18bcdcad05709cfef"
...
interface NewsApiService {
    ...
    @GET("top-headlines?${PARAMETER}category=business&apiKey=$API_KEY")
    suspend fun getBusinessNewsApi():News
    @GET("top-headlines?${PARAMETER}category=entertainment&apiKey=$API_KEY")
    suspend fun getEntertainmentNewsApi():News
    @GET("top-headlines?${PARAMETER}category=general&apiKey=$API_KEY")
    suspend fun getGeneralNewsApi():News
    @GET("top-headlines?${PARAMETER}category=health&apiKey=$API_KEY")
    suspend fun getHealthNewsApi():News
    @GET("top-headlines?${PARAMETER}category=science&apiKey=$API_KEY")
    suspend fun getScienceNewsApi():News
    @GET("top-headlines?${PARAMETER}category=sports&apiKey=$API_KEY")
    suspend fun getSportsNewsApi():News
    @GET("top-headlines?${PARAMETER}category=technology&apiKey=$API_KEY")
